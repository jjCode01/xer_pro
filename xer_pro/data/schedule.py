...
class Schedule:
    def __init__(self, proj_id: str, **tables) -> None:
        ...
        self._calendars = {
            cal['clndr_id']: SchedCalendar(**cal)
    ...
    def logic(self, fs: bool = False, ff: bool = False, ss: bool = False, sf: bool = False) -> list[Relationship]:
        ...
        rels = sorted(self._logic.values(), key=lambda x: [x.predecessor.activity_id, x.successor.activity_id])
    ...
    def tasks(self,
              ...
              completed: bool = False) -> tuple[Task]:
